...
import study.oop.netty.nettysecondtask.client.game.Client;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        ((HelloController)fxmlLoader.getController()).setEventListeners();
        scene.setOnKeyPressed(e -> {
            ((HelloController)fxmlLoader.getController()).handleKeyboardPress(e);
        });
        scene.setOnKeyReleased(e -> {
            ((HelloController)fxmlLoader.getController()).handleKeyboardRelease(e);
        });
